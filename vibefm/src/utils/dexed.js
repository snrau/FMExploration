...
export const dx7Parameters = {
    ...
    OP6_EG_RATE2: { number: 1, max: 99, default: 60, change: true },
    OP6_EG_RATE3: { number: 2, max: 99, default: 60, change: true },
    OP6_EG_RATE4: { number: 3, max: 99, default: 60, change: false },
    OP6_LVL1: { number: 4, max: 99, default: 0, change: false },
    OP6_LVL2: { number: 5, max: 99, default: 99, change: false },
    OP6_LVL3: { number: 6, max: 99, default: 85, change: false },
    ...
    OP5_EG_RATE2: { number: 22, max: 99, default: 60, change: true },
    OP5_EG_RATE3: { number: 23, max: 99, default: 60, change: true },
    OP5_EG_RATE4: { number: 24, max: 99, default: 60, change: false },
    OP5_LVL1: { number: 25, max: 99, default: 0, change: false },
    OP5_LVL2: { number: 26, max: 99, default: 99, change: false },
    OP5_LVL3: { number: 27, max: 99, default: 85, change: false },
    ...
    OP4_EG_RATE2: { number: 43, max: 99, default: 60, change: true },
    OP4_EG_RATE3: { number: 44, max: 99, default: 60, change: true },
    OP4_EG_RATE4: { number: 45, max: 99, default: 60, change: false },
    OP4_LVL1: { number: 46, max: 99, default: 0, change: false },
    OP4_LVL2: { number: 47, max: 99, default: 99, change: false },
    OP4_LVL3: { number: 48, max: 99, default: 85, change: false },
    ...
    OP3_EG_RATE2: { number: 64, max: 99, default: 60, change: true },
    OP3_EG_RATE3: { number: 65, max: 99, default: 60, change: true },
    OP3_EG_RATE4: { number: 66, max: 99, default: 60, change: false },
    OP3_LVL1: { number: 67, max: 99, default: 0, change: false },
    OP3_LVL2: { number: 68, max: 99, default: 99, change: false },
    OP3_LVL3: { number: 69, max: 99, default: 85, change: false },
    ...
    OP2_EG_RATE2: { number: 85, max: 99, default: 60, change: true },
    OP2_EG_RATE3: { number: 86, max: 99, default: 60, change: true },
    OP2_EG_RATE4: { number: 87, max: 99, default: 60, change: false },
    OP2_LVL1: { number: 88, max: 99, default: 0, change: false },
    OP2_LVL2: { number: 89, max: 99, default: 99, change: false },
    OP2_LVL3: { number: 90, max: 99, default: 85, change: false },
    ...
    OP1_EG_RATE2: { number: 106, max: 99, default: 60, change: true },
    OP1_EG_RATE3: { number: 107, max: 99, default: 60, change: true },
    OP1_EG_RATE4: { number: 108, max: 99, default: 60, change: false },
    OP1_LVL1: { number: 109, max: 99, default: 0, change: false },
    OP1_LVL2: { number: 110, max: 99, default: 99, change: false },
    OP1_LVL3: { number: 111, max: 99, default: 85, change: false },
